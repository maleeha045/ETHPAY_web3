...
const Card = (props) => {
  ...
  return (
    ...
    <div className='singleTransaction'>
      ...
      <a href={`https://rinkeby.etherscan.io/address/${props.addressFrom}`} target='_blank' rel='noreferrer'>
     <p className='addressFrom'>From: {shortAddress(props.addressFrom)}</p>
     </a>
     <a href={`https://rinkeby.etherscan.io/address/${props.addressTo}`} target='_blank' rel='noreferrer'>
